...
% INITIALIZE
    ...
    %  selected
        disp('SCRIPTS/Reformat_Frames.m entered');
    ...
    % Export to workspace
        ...
        prompt={'New number of frames (slices are recalculated to match number of frames)'};
        title='Input number of frames'; numlines=1; defaultanswer={'1'};
    ...
    % Reformat image
        ...
        z=size(imlook4d_Cdata,3)*size(imlook4d_Cdata,4)/frames;

        imlook4d_Cdata=reshape(imlook4d_Cdata,x,y,z,frames);
    ...
    % Set title
        set(newHandles.figure1,'Name', [imlook4dWindowTitle '(reformatted)']);
    ...
    % Finish
        ...
        disp('SCRIPTS/Reformat_Frames.m DONE');
