...
% TEST_CONTROL M-file for test_control.fig
...
%
   disp('Entered test_control_OpeningFcn');
    ...
    %   
        ...
        try
            set(handles.ROIPopupmenu, 'Value', imlook4d_handles.model.test.ROINumber);
        catch
        end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    % Initiate
    %
        disp('Entered test_control/DonePushbutton_Callback');
    ...
    %
        ...
        imlook4d_handles.model.test.ROIString=ROIStrings{index};
        imlook4d_handles.model.test.ROINumber=index;
       ...
       % [activity, NPixels]=generateTACT(imlook4d_handles, imlook4d_handles.image.Cdata, imlook4d_handles.image.ROI);
        ...
        imlook4d_handles.model.test.TACT=activity(index,:)
    ...
    %
        ...
        imlook4d_handles.model.functionHandle=@test;            % CHANGE THIS ONE 
