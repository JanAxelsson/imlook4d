...
%
% Calculate Linearized water x and y axes for ROIs 
%
...
%
   ...
   for i=1:numberOfROIs
        ...
        plot( xValues, yValues, xValues2,yValues2);  % Plot straight line
   end
...
%                 };
            ...
            text('Position',[0.95,0.4,0],'String',myAnnotation,'Units','normalized','HorizontalAlignment','Right','FontName','FixedWidth')
