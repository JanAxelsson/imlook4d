...
matlabbatch{1}.spm.spatial.preproc.tissue(1).warped = WARPED_TISSUE_CLASS_IMAGE;
...
matlabbatch{1}.spm.spatial.preproc.tissue(2).warped = WARPED_TISSUE_CLASS_IMAGE;
...
matlabbatch{1}.spm.spatial.preproc.tissue(3).warped = WARPED_TISSUE_CLASS_IMAGE;
...
matlabbatch{1}.spm.spatial.preproc.tissue(4).warped = WARPED_TISSUE_CLASS_IMAGE;
...
matlabbatch{1}.spm.spatial.preproc.tissue(5).warped = WARPED_TISSUE_CLASS_IMAGE;
matlabbatch{1}.spm.spatial.preproc.tissue(6).tpm = {[which('TPM.nii') ',6']};
matlabbatch{1}.spm.spatial.preproc.tissue(6).ngaus = 2;
matlabbatch{1}.spm.spatial.preproc.tissue(6).native = NATIVE_TISSUE_CLASS_IMAGE;
matlabbatch{1}.spm.spatial.preproc.tissue(6).warped = WARPED_TISSUE_CLASS_IMAGE;
