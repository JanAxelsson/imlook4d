...
% DISPLAY ROI info
totalActivityUnit = [ imlook4d_current_handles.image.unit '*mL' ];
if strcmp(imlook4d_current_handles.image.unit, 'BQML')
    totalActivityUnit = 'BQ';
end
...
dialogText = { char( {...
    ...
    ['Total activity [' totalActivityUnit '] =                     ' TAB num2str(activity) ]; ... 
