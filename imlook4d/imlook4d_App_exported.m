classdef imlook4d_App_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
                                   ...
                                   % Read help text
                                       try
                                           % Get possible file names
                                            ...
                                            % if strcmp(hObject.Style,'uimenu')
        ...
        function imlook4d_set_defaults(app, hObject, eventdata, handles)
            ...
            %%[hObject, eventdata, handles] = myConvertToGUIDECallbackArguments(app, event); %#ok<ASGLU>
        ...
        function handles = makeSubMenues(app, handles, parentMenuHandle, subMenuFolder)
                    ...
                    for j=1:length(menuItemNames)
                        ...
                        if strcmp(ext,'.m')
                            ...
                            % For SCRIPTS, MODEL,
                            callBack = [ ...
                                'if @(app, event)app.DisplayHelp( app, event) ' ...
                                '   return; ' ...
                                'end;' ...
                                ' '...
                            ...
                            callBack = [ ...
                                'assignin(''base'', ''imlook4d_current_handle'', gcf );eval(''' name ''') ' ...
                            ];

                            % callBack = [ ...
                            %     ['assignin(''base'', ''imlook4d_current_handle'', gcf );...' ...
                            %     '@(src, event) assignin(''base'', ''imlook4d_app'', src.UserData.app ); ' ...
                            %     'evalin( ''base'', '''] name ''') ' ...
                            % ];

                            % % Callback the script, after adding  imlook4d_current_handle, and app 
                            % callBack = [ ...
                            %     'assignin(''base'', ''imlook4d_current_handle'', gcf );@(src, event) assignin(''base'', ''imlook4d_app'', src.UserData.app ) ;eval(''' name ''') ' ...
                            % ];
 ...
 %set(handles.scriptsMenuHandle, 'MenuSelectedFcn', @(src, event) ScriptsMenu_Callback(app, event));
    ...
    methods (Access = private)
        ...
        function imlook4d_OpeningFcn(app, varargin)
            ...
            % Create GUIDE-style callback args - Added by Migration Tool
            [hObject, eventdata, handles] = myConvertToGUIDECallbackArguments(app); %#ok<ASGLU>
...
set(app.figure1, 'UsedByGUIData_m', []);
        ...
        function EditScale_Callback(app, event)
            ...
            % Create GUIDE-style callback args - Added by Migration Tool
            [hObject, eventdata, thisHandles] = myConvertToGUIDECallbackArguments(app, event); %#ok<ASGLU>
        ...
        % Value changed function: FrameNumSlider
        ...
        function copyRoiBetweenYokes_Callback(app, event)
            ...
            % Create GUIDE-style callback args - Added by Migration Tool
            [h, evd, thisHandles] = myConvertToGUIDECallbackArguments(app, event); %#ok<ASGLU>
        ...
        function measureTape_CopyValues(app, event)
            % Create GUIDE-style callback args - Added by Migration Tool
            [copyValuesContextMenuItem, eventdata, handles] = myConvertToGUIDECallbackArguments(app, event); %#ok<ASGLU>
    ...
    %             end
        ...
        function mouseDown_Callback(app, event)
            ...
            % Create GUIDE-style callback args - Added by Migration Tool
            [h, evd, handles] = myConvertToGUIDECallbackArguments(app, event); %#ok<ASGLU>
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.text22.Position = [3 62 54.7966101694915 17.3383084577114];
            ...
            app.PC_high_slider.MinorTicks = [1 51 101 151 201 251 301 351 401 451 501 551 601 651 701 751 801 851 901 951 1000];
