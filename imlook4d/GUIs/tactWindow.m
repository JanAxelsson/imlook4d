...
% On Open    
    ...
    % --- Executes just before tactWindow is made visible.
        ...
        if isfield(ROI_data_struct,'pve')
            % PVE-corrected
            datastruct.names = {'pvc-mean', 'mean', 'volume', 'pixels','max', 'min', 'std','skew','kurt','uniformity','entropy'};
            datastruct.units = {'', '', '', '', '', '', '', '', '', '', ''};
            datastruct.pars = { ROI_data_struct.pve', ...
                ROI_data_struct.mean', ...
                ROI_data_struct.volume', ...
                ROI_data_struct.Npixels', ...
                ROI_data_struct.max', ...
                ROI_data_struct.min', ...
