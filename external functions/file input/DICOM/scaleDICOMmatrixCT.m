...
function scaled=scaleDICOMmatrixCT(header,data)
...
disp2('START scaleDICOMmatrixCT');
...
close(waitBarHandle); 
disp2([' max(scaled(:))=' num2str( max(scaled(:))) ]);
disp2('END scaleDICOMmatrixCT');