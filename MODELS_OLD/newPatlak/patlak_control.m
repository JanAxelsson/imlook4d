function varargout = patlak_control(varargin)

% PATLAK_CONTROL M-file for patlak_control.fig
%      PATLAK_CONTROL, by itself, creates a new PATLAK_CONTROL or raises the existing
%      singleton*.
%
%      H = PATLAK_CONTROL returns the handle to a new PATLAK_CONTROL or the handle to
%      the existing singleton*.
%
%      PATLAK_CONTROL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PATLAK_CONTROL.M with the given input arguments.
%
%      PATLAK_CONTROL('Property','Value',...) creates a new PATLAK_CONTROL
%      or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before patlak_control_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to patlak_control_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help patlak_control

% Last Modified by GUIDE v2.5 07-Dec-2010 17:54:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @patlak_control_OpeningFcn, ...
                   'gui_OutputFcn',  @patlak_control_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before patlak_control is made visible.
function patlak_control_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to patlak_control (see VARARGIN)

% Choose default command line output for patlak_control
...
%
   disp('Entered patlak_control_OpeningFcn');
    ...
    %            
            ...
            try
                % Set radio buttons
                if (strcmp(imlook4d_handles.model.Patlak.type, 'slope') )
                ...
                % Set list-box
                set(handles.referenceDataEdit,'String', imlook4d_handles.model.Patlak.referenceData);

                % Set GUI according to imlook4d model handles
                imlook4d_handles.model.Patlak.referenceData   % Save TACT curve 
                set(handles.startFrameSlider,'Value', imlook4d_handles.model.Patlak.startFrame);
                set(handles.startFrameEdit  ,'String',imlook4d_handles.model.Patlak.startFrame);
                set(handles.endFrameSlider  ,'Value', imlook4d_handles.model.Patlak.endFrame);
                set(handles.endFrameEdit    ,'String',imlook4d_handles.model.Patlak.endFrame);
                set(handles.integralOffsetEdit, 'String', num2str(imlook4d_handles.model.Patlak.integralOffset));
           catch
                disp('First time opening Patlak from this instance of imlook4d');
                set(handles.endFrameSlider  ,'Value', numberOfFrames);
                set(handles.endFrameEdit    ,'String',numberOfFrames);
           end
    %
    % FINISH
    %
...
% UIWAIT makes patlak_control wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = patlak_control_OutputFcn(hObject, eventdata, handles) 
...
% -------------------------------------------------------------------------
    ...
    function integralOffsetText_CreateFcn(hObject, eventdata, handles)
% hObject    handle to integralOffsetEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function integralOffsetEdit_Callback(hObject, eventdata, handles)
% hObject    handle to integralOffsetEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of integralOffsetEdit as text
%        str2double(get(hObject,'String')) returns contents of integralOffsetEdit as a double
...
% handles    structure with handles and user data (see GUIDATA)
        ...
        % Define imlook4d callback function
            imlook4d_handles.model.functionHandle=@patlak;              % CHANGE THIS ONE
            
        % Save into imlook4d handles
            %imlook4d_handles.model.Patlak.referenceData=activity(activeROI,:);   % Save TACT curve 
            imlook4d_handles.model.Patlak.startFrame=round(get(handles.startFrameSlider,'Value'));
            endFrame=round(get(handles.endFrameSlider,'Value'));
            imlook4d_handles.model.Patlak.endFrame=endFrame;
            imlook4d_handles.model.Patlak.integralOffset=str2num(get(handles.integralOffsetEdit,'String'));
            %imlook4d_handles.model.Patlak.integrationRange=startFrame:endFrame;
            
        % Determine if slope/intercept image
            if (get(handles.slopeRadiobutton,'Value')==1)
                imlook4d_handles.model.Patlak.type='slope';
            end

            if (get(handles.interceptRadiobutton,'Value')==1)
                imlook4d_handles.model.Patlak.type='intercept';
            end  
        ...
        % Get reference data from text field, line-by-line
            ...
            imlook4d_handles.model.Patlak.referenceData=referenceData;
...
function integralOffsetEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to integralOffsetEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
