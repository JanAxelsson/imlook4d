...
% OLD VERSION
%       outputImage(:,:,1,1)=imlook4d_patlak(...
%             matrix, ...
%             handles.image.time, ...
%             handles.image.duration, ...
%             handles.model.Patlak.startFrame, ...
%             handles.model.Patlak.endFrame, ...
%             handles.model.Patlak.referenceData, ...
%             handles.model.Patlak.type );
